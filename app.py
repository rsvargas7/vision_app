...
st.set_page_config(page_title="Procesamiento de imagen", layout="centered", initial_sidebar_state="collapsed")
# Streamlit page setup
st.title("Procesamiento de Imagen")
...
show_details = st.toggle("Agrega información sobre la imagen", value=False)
